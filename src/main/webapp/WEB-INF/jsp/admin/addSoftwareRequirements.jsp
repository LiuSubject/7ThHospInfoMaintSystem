        ...
        <div class="col-md-10">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <div class="row">
                        <h2 style="text-align: center;margin-bottom: 20px " class="col-md-10">需求申请</h2>
                    </div>
                </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <select class="form-control" name="requireType" id="requireType">
                                    <option value="0">流程变更</option>
                                    <option value="1">功能变更</option>
                                    <option value="2">应用出错</option>
                                    <option value="3">系统升级</option>
                                    <option value="4">功能新增</option>
                                    <option value="5">数据维护</option>
                                </select>
                            </div>
                        </div>
                        <div class="form-group">
