...
<div class="col-md-2">
    <ul class="nav nav-pills nav-stacked" id="nav">
        <li><a href="/admin/showCourse">故障申报<span class="badge pull-right">8</span></a></li>
        <li><a href="/admin/showCourse">物资申购<span class="badge pull-right">8</span></a></li>
        <li><a href="/admin/showCourse">机房巡检<span class="badge pull-right">8</span></a></li>
